...
import { type DataTableColumn, type DataTableProps, DataTableVariant, type LocalStorageColumns } from './dataTableTypes';
...
const DataTableComponent = ({
  ...
  const buildColumns = (withLocalStorage = true) => {
    console.log("BITE?", dataColumns, localStorageColumns);
