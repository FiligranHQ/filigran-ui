...
import { defaultColumnsMap, getDefaultFilterObject, useDataCellHelpers, useDataTableComputeLink, useDataTableFormatter, useDataTableLocalStorage, useDataTablePaginationLocalStorage, useDataTableToggle } from '../../utils';
import { makeData } from 'filigran-website/utils/makeData';
import { Badge, Button } from '../../../servers';

export const DataTableExample = React.forwardRef<HTMLDivElement>((props, ref) => {
      ...
      filtersComponent={(
        <div style={{ display: 'flex', flex: 1, justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', gap: 4 }}>
            ...
            />
            <Button variant="outline" className="text-darkblue-300 border-darkblue-300">AI insight</Button>
            <Button variant="outline" className="text-primary border-primary">Import</Button>
