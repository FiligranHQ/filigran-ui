...
const DataTableLine = ({
  ...
  const linkStyle: CSSProperties = {
    ...
    borderColor: (theme && theme.palette?.mode === "dark") ? 'hsl(var(--gray-800))' : 'hsl(var(--gray-150))',
          ...
          >
            <Checkbox
              ...
              sx={{
                ...
                color: (theme && theme.palette?.mode === "dark") ? 'hsl(var(--text-inverted-foreground))' : 'hsl(var(--text-foreground))'
              }}
              checked={
                (selectAll
