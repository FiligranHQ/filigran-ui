...
export const ArrowUpwardAltIcon = lazy(() => import("./ArrowUpwardAlt"));
...
export const CalendarMonthIcon = lazy(() => import("./CalendarMonth"));
...
export const MenuIcon = lazy(() => import("./Menu"));
export const MoonIcon = lazy(() => import("./Moon"));
...
export const UsersIcon = lazy(() => import("./Users"));
export const VisibilityOffIcon = lazy(() => import("./VisibilityOff"));
export const VpnKeyIcon = lazy(() => import("./VpnKey"));
