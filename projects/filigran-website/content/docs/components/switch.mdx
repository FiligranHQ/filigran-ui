...
Displays a switch that can be clicked.
        ...
        <div className="flex items-center gap-m">
                      <Switch id="notifications-checked" checked />
                      <label htmlFor="notifications-checked" className="cursor-pointer">
                        This is a free switch checked!
                      </label>
                </div>
       <div className="flex items-center gap-m">
              <Switch id="notifications2" disabled checked />
              <label htmlFor="notifications2" className="cursor-pointer">
                This is a disabled checked switch!
              </label>
        </div>
       <div className="flex items-center gap-m">
              <Switch id="notifications3" disabled />
