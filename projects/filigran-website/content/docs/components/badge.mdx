...
<Badge color='#c73220'>Custom Hex</Badge>
<Badge color='hsl(24, 12%, 68%)'>Custom HSL</Badge>
<Badge color='rgb(183, 171, 232)' style={'test'}>Custom RGB</Badge>
...
| ----------- | ---------------------------------------------------------------------------- | --------- | ----------------------------- |
| **variant** | _enum_ ("default" \| "secondary" \| "warning" \| "destructive" \| "outline") | "default" | This changes the badge color. |
