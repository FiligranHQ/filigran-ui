...
<h5 className="font-jumbo">Jumbo</h5>
```
<h5 className="font-jumbo">Jumbo</h5>
```

<h5 className="font-title">Title </h5>
```
<h5 className="font-title">Title </h5>
```

<h5 className="font-subtitle">Subtitle </h5>
```
<h5 className="font-subtitle">Subtitle </h5>
```

<h5 className="font-category">Category </h5>
```
<h5 className="font-category">Category </h5>
```

<h5 className="font-tab">Tab title </h5>
```
<h5 className="font-tab">Tab title </h5>
```

<h5 className="font-container-title">Container title </h5>
```
<h5 className="font-container-title">Container title </h5>
```

<div className="font-bold font-default">Default Content / Text / Buttons</div>
...
<div className="font-bold font-sub-content">
  Sub content / subtext / tooltips / tag / graph titles / breadcrumbs
</div>
<div className="font-sub-content">
...
<div className="font-bold font-mini">Mini</div>
<div className="font-mini">
  Experts warn of a new ATM malware family that is advertised in the cybercrime
  underground, it was developed to target Europe. A threat actor is advertising
  a new ATM malware family that claims to be able of compromised 99% of devices
  in Europe. The threat actor is offering the malware for $30,000, he claims
...
<div className="bg-white flex flex-col p-xl gap-s">
  <h5 className='font-category'> Description</h5>
  <div className="font-sub-content p-m bg-darkblue-100"> Iperdiet, eu ultricies nibh varius. Nulla tincidunt mauris nec vehicula tincidunt. Nullam in ante lacinia ante convallis viverra et ac enim. Suspendisse maximus quam dui. Aliquam .</div>
  <div className="font-default">Experts warn of a new ATM malware family that is advertised in the cybercrime underground, it was developed to target Europe. A threat actor is advertising a new ATM malware family that claims to be able of compromised 99% of devices in Europe. The threat actor is offering the malware for $30,000, he claims that […]</div>
</div>
```

<div className="flex flex-col gap-s bg-white p-xl">
  <h5 className="font-category"> Description</h5>
  <div className="bg-darkblue-100 p-m font-sub-content">
    {' '}
