...
export const Menu: FunctionComponent<MenuProps> = ({
  ...
  return (
    <aside
      className={cn(
        'mobile:hidden z-9 sticky top-[4rem] flex h-[calc(100vh-4rem)] w-48 shrink-0 flex-col overflow-y-auto overflow-x-hidden border-r border-r-border bg-page-background py-s duration-300 ease-in-out'
      )}>
